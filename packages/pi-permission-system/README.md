...
An explicit `/skill:<name>` invocation is user input rather than a tool call and is not permission-gated; tool calls made afterward still follow the flow above.
